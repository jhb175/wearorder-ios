...
| 7 | 预设穿搭 | OOTD 保留为预设库，一套预设可重复安排到未来日期 | 约 90% | 真机检查标签、搜索、排序和计划选择预设 |
...
- 7-10 本次补齐：OOTD 预设标签、预设库标签筛选和排序、计划地点/天气城市字段、备份/导出/数据修复兼容和对应单元测试。
- 当前打包建议版本：`1.0.0 (12)`。下一次重新上传 TestFlight 需要继续递增 Build Number。
